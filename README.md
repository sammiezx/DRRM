...
written for a **practising road and highway engineer in Nepal**.
...
Written for a **road and highway engineer**, with a water background — so the centre of
gravity is slopes, hydrology and the road itself, not buildings. That is also where Nepal
genuinely leads the field: bio-engineering and the Green Roads approach are Nepali
contributions, cited internationally.
...
| I | **The Ground** | Why Nepal's hills move, and how hazards arrive as chains |
| II | **Reading the Terrain** | Slope mechanics, movement types, debris flow, reading a hillside, rock — and how roads manufacture landslides |
| III | **Water** | Catchments, design discharge, river behaviour, flood and GLOF, scour, river training |
| IV | **The Road That Survives** | Alignment, drainage, cross-drainage, walls, bio-engineering, Green Roads, bridges under hazard |
| V | **Beyond the Alignment** | Roads as lifelines, the first 72 hours, buildings compressed, recovery, land and money |
| ≡ | **Practice Kit** | Checklists, numbers, question bank, glossary, sources |

Every session ends with a **field assignment** — fifteen minutes, on the roads he already
drives — and **check yourself** questions with answers hidden until tapped.
...
- **Flashcards** — definitions, Nepal events, standards and clauses, numbers, field indicators, failure modes
